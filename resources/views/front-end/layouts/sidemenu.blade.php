<aside class="main-sidebar sidebar-light-info elevation-4">
    ...
    <a href="{{route('admin.home')}}" class="brand-link">
        <span class=""><img src="{{asset('dist/img/WorkOrbit.png')}}" alt="AdminLTE Logo" style="
    width: 227px;
    cursor:pointer;
"></span>
    </a>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endif
                            ...
                            @if(hasPermission('staff_report_list'))
                        <li class="nav-item">
                            <a href="{{route('admin.staff-vetting.report')}}" class="nav-link">
                                <i class="far fa-users nav-icon"></i>
                                <p>Staff Vetting Report</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('admin.report.designation')}}" class="nav-link">
                                <i class="far fa-users nav-icon"></i>
                                <p>Designation Report</p>
                            </a>
                        </li>
                        @endif
                        <li class="nav-item">
